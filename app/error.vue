<!-- This page is base on built-in Nuxt error page, you can customize it to fit your needs -->
...
<template>
  <div text="black dark:white" font-sans px-10 py-12 bg="white dark:[#020420]" flex="~ col" min-h-screen antialiased>
